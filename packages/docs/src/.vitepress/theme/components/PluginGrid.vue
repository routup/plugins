        ...
        plugins: [
            {
                ...
                bullets: ['@DController + method decorators', 'Parameter injection', 'OpenAPI source for swagger-preset'],
            },
        ],
    },
    {
        ...
        plugins: [
            {
                ...
                href: '/swagger/',
                accent: '#22c55e',
                summary: 'Generator (V2 + V3) plus Swagger UI mountable on any path.',
            ...
            },
            {
                ...
                href: '/swagger-preset/',
                accent: '#16a34a',
                summary: 'The @trapi/metadata preset that decodes routup decorators.',
                bullets: ['Maps @D* decorators', 'Used by the swagger generator', 'Customizable on top of buildPreset()'],
            },
        ],
    },
    {
