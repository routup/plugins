        ...
        plugins: [
            {
                ...
                href: '/swagger-ui/',
                accent: '#16a34a',
                summary: 'Mount Swagger UI on any router path from a JSON document, URL, or in-memory spec.',
                bullets: ['swagger-ui-dist assets', 'File / URL / object input', 'Custom base paths'],
            },
        ],
    },
    {
